...
class DecoderSplattingCUDA(Decoder[DecoderSplattingCUDACfg]):
    ...
    def forward(
        ...
        # print("color before shape", color.shape)
        color = rearrange(color, "(b v) c h w -> b v c h w", b=b, v=v)
        # print("color after shape", color.shape)
        # print("depth before shape", depth.shape)
        # depth = depth.squeeze(1)
        # print("depth after shape", depth.shape)
    ...
    def render_depth(
        ...
        # print('rearrange(result, "(b v) h w -> b v h w", b=b, v=v)', rearrange(result, "(b v) h w -> b v h w", b=b, v=v).shape)
